...
class TsSimpleNpc extends UE.KuroEffectActor {
  ...
  EditorInit() {
    super.EditorInit(),
      ...
      this.LoadModel(),
      this.Tags.Contains(CharacterNameDefines_1.CharacterNameDefines.PFT_NO_SPAWN) ||
        ...
        if (this.Mesh)
          if (0 === this.Mesh.AnimationMode) {
            if (
              ...
              return (
                (this.TempAnimInstance = this.Mesh.AnimScriptInstance), void (this.IsDirty = !0)
              );
          } else if (
            ...
            return (
              (this.TempAnimAsset = this.Mesh.AnimationData.AnimToPlay), void (this.IsDirty = !0)
            );
        this.TempDaPath !== this.DA.AssetPathName?.toString()
          ? ((this.TempDaPath = this.DA.AssetPathName.toString()), (this.IsDirty = !0))
          : this.IsDirty
            ? ((this.IsDirty = !1), this.LoadModel(), UE.KuroStaticLibrary.SetActorModify(this))
  ...
  InitRenderInfo() {
    this.CharRenderingComponent.Init(3), this.SetPrimitiveEntityType(2), this.SetAnimUROParams();
  }
  InitDaInfo() {
  ...
  LoadModelByDA() {
    ...
    return !(
      ...
      (ResourceSystem_1.ResourceSystem.LoadAsync(i, UE.PD_NpcSetupData_C, (i) => {
  ...
  get IsLodShow() {
    return !(
      ...
      GameSettingsDeviceRender_1.GameSettingsDeviceRender.GameQualitySettingLevel < this.LodLevel
    );
  }
  SetAnimUROParams() {
